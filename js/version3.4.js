...
function LaunchCul(){
    ...
    if(comb.value !== undefined){
        ...
        if(comb.name === "Chouette-Velute"){
            document.getElementById("combination").style.backgroundColor = '#4682b4';
            document.getElementById("chouettevelute").style.backgroundColor = '#4682b4';
        }
    }
...
function ResetDice(){
    ...
    document.getElementById("points").innerHTML = ``;
    document.getElementById("points").style.backgroundColor = '';
    document.getElementById("chouettevelute").style.background = '';
}
